...
<html>
    <head>
        ...
        <title>Dixon-Batteries | Create Dealer</title>
            ...
            <div class="content-wrapper" style="min-height: 946.3px;">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#" class="active">Create Dealer</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form  id="dealer-form" action="{{ url('/dealer/add') }}"  data-toggle="validator" method="post">
                                    {!! csrf_field() !!}
                                    <div class="box-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="dealer_code" value="{{ old('dealer_code') }}" placeholder="Enter dealer code">
                                                <span class="help-block has-error" id="dealer_code-error"/>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="">GST No <span class="label-star">*</span></label>
                                                <input type="text" class="form-control" name="gst_no" value="{{ old('gst_no') }}" placeholder="Enter GST No">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="vat_no" value="{{ old('vat_no') }}" placeholder="Enter VAT No">
                                                <span class="help-block has-error" id="vat_no-error"/>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="">Rating <span class="label-star">*</span></label>
                                                <input type="text" class="form-control" name="rating" value="{{ old('rating') }}" placeholder="Enter rating">
