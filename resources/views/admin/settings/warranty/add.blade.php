                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-9">
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-body ">
                                                <form  id="category-form" action="{{ url('/settings/warranty/add') }}"  data-toggle="validator" method="post">
                                                    {!! csrf_field() !!}
                                                    <div class="box-body">
                                                        <div class="row">
                                                            <div class="col-md-6 form-group">
                                                                <label for="">Warranty(In Months) <span class="label-star">*</span> </label>
                                                                <input type="text" class="form-control" name="months" value="{{ old('months') }}" placeholder="Enter months">
