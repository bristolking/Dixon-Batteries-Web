...
<html>
    <head>
        ...
        <title>Dixon-Batteries | Categories</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                <section class="content" ng-app="categoriesApp" ng-controller="categoriesController" ng-cloak="">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <button id="btnExport" name="btnExport" style="display:none" ng-json-export-excel data="filteredItemsdata" 
                report-fields="{category_name: 'Category',category_desc:'Description',created_at:'Date/Time'}" filename =" 'Categories' "></button>
                                    <button class="btn btn-primary btn-xs mrg pull-left" ng-click="exportExcel()">Export CSV</button>
                                    <a href="{{ url('/category/add')}}" class="btn btn-primary btn-xs mrg pull-right">Add</a>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <table id="" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th ng-click="sort_by('category_desc');"> Description <i class="glyphicon glyphicon-sort-by-attributes"></i></th>
                                            ...
                                            <tbody ng-show="filteredItems > 0">
                                                <tr ng-repeat="data in filtered = (list| filter:search | orderBy : predicate :reverse) | startFrom:(currentPage - 1) * entryLimit | limitTo:entryLimit">
                                                    ...
                                                    <td ng-if="data.status == '1'" style="text-align:center">
                                                        <a href="">
                                                            <span class="label label-success" ng-click="update_status(data.category_id, 0)">
                                                                APPROVED
                                                            </span>
                                                        </a>
                                                    </td>
                                                    <td ng-if="data.status == '0'" style="text-align:center">
                                                        <a href="">
                                                            <span class="label label-danger" ng-click="update_status(data.category_id, 1)">
                                                                DENIED
                                                            </span>
                                                        </a>
                                                    </td>
                                                    <td style="text-align:center">
                                                        <a href="{{ url('/category/edit')}}/@{{ data.category_id}}" class="btn btn-info btn-xs mrg"><i class="fa fa-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <script>
                                                ...
                                                var app = angular.module('categoriesApp', ['ui.bootstrap','ngJsonExportExcel']);
                                                //For List
                                                ...
                                                app.controller('categoriesController', function ($scope, $http, $timeout) {
                                                $http({
                                                method: 'GET',
                                                        url: '{{ url('categories_list_json') }}'
                                                ...
                                                $http({
                                                method: 'GET',
                                                        url: '{{ url('update_status') }}/categories/' + id + '/' + status
                                                }).then(function successCallback(response) {
                                                $scope.reload();
                                                });
                                                }
