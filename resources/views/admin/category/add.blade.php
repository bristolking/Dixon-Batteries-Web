...
<html>
    <head>
        ...
        <title>Dixon-Batteries | Create Category</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form  id="category-form" action="{{ url('/category/add') }}"  data-toggle="validator" method="post">
                                    {!! csrf_field() !!}
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <textarea class="form-control" name="category_desc" placeholder="Enter description">{{ old('category_desc') }}</textarea>
                                                <span class="help-block has-error" id="category_desc-error"/>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
