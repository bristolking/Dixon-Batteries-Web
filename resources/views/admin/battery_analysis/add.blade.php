...
<html>
    <head>
        ...
        <title>Dixon-Batteries | Create Battery Analysis</title>
        ...
        <div class="wrapper" style="height: auto; min-height: 100%;">
            ...
            <div class="content-wrapper" style="min-height: 946.3px;">
                ...
                <section class="content-header">
                    <h1>
                        Create Battery Analysis
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ url ( '/' ) }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="{{ url('/battery_analysis') }}">Battery Analysis</a></li>
                        <li><a href="#" class="active">Create Battery Analysis</a></li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form  id="product-form" action="{{ url('/battery_analysis/add') }}"  data-toggle="validator" method="post">
                                    {!! csrf_field() !!}
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="battery_sno" value="{{ old('battery_sno') }}" placeholder="Enter serial number">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="">OCV </label>
                                                <input type="text" class="form-control" name="ocv" value="{{ old('ocv') }}"  placeholder="Enter ocv" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="physical_status" value="{{ old('physical_status') }}" placeholder="Enter physical status" >
                                                <span class="help-block has-error" id="physical_status-error"/>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="">Acid Level <span class="label-star">*</span></label>
                                                <input type="text" class="form-control" name="acid_level" value="{{ old('acid_level') }}" placeholder="Enter acid level">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="cell_wise_acid_sp_gr" value="{{ old('cell_wise_acid_sp_gr') }}" placeholder="Enter cell wise acid">
                                                <span class="help-block has-error" id="cell_wise_acid_sp_gr-error"/>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="">Charge Details </label>
                                                <input type="text" class="form-control" name="charge_details" value="{{ old('charge_details') }}" placeholder="Enter charge details">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="test_details" value="{{ old('test_details') }}" placeholder="Enter test details">
                                                <span class="help-block has-error" id="test_details-error"/>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="">Battery Resends On </label>
                                                <input type="text" class="form-control datepicker" readonly="" name="battery_resend_on" value="{{ old('battery_resend_on') }}" placeholder="Enter resends on">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="replaced_battery_sno" value="{{ old('replaced_battery_sno') }}" placeholder="Enter replaced serial number">
