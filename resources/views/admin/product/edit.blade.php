...
<html>
    <head>
        ...
        <title>Dixon-Batteries | Update Product</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form  id="product-form" action="{{ url('/product/edit') }}/{{ $product->product_id }}"  data-toggle="validator" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                    <div class="box-body">
                                        <input type="hidden" name="ori_image" value="{{ $product->image_paths }}"/>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="container" value="{{ $product->container }}" placeholder="Enter container">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="capacity" value="{{ $product->capacity }}" placeholder="Enter capacity">
                                                <span class="help-block has-error" id="capacity-error"/>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="">Length(Dimention:MM) <span class="label-star">*</span> </label>
                                                <input type="text" class="form-control" name="length" value="{{ $product->length }}" placeholder="Enter length">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="width" value="{{ $product->width }}" placeholder="Enter width">
                                                <span class="help-block has-error" id="width-error"/>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="">Height(Dimention:MM) <span class="label-star">*</span> </label>
                                                <input type="text" class="form-control" name="height" value="{{ $product->height }}" placeholder="Enter height">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="charging_current" value="{{ $product->charging_current }}" placeholder="Enter charging current">
                                                <span class="help-block has-error" id="charging_current-error"/>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="">Filled Weight <span class="label-star">*</span> </label>
                                                <input type="text" class="form-control" name="filled_weight" value="{{ $product->filled_weight }}" placeholder="Enter filled weight">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <select class="form-control select2" value="{{ $product->category_id }}" onchange="get_sub_categories(this.value);">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <select class="form-control select2" id="sub_categories" name="sub_category_id">
                                                    <option value="">Please select...</option>
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="points" value="{{ $product->points }}" placeholder="Enter points">
...
//                        var output = document.getElementById('show_upload');
        ...
        <script>
            $().ready(function () {
                var category_id = "@php echo $product->category_id @endphp";
                get_sub_categories(category_id);
            });
            function get_sub_categories(category_id) {
                if (category_id != '') {
                    $("#overlay").show();
                    var select_id = "@php echo $product->sub_category_id @endphp";
                    $.ajax({
